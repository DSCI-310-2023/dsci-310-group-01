...
```{r day-boxplot, fig.cap="Actual Productivity by Day of the Week Boxplot", out.width="60%", echo=FALSE}
knitr::include_graphics("../results/day_boxplot.png")
```

```{r half-boxplot, fig.cap="Actual Productivity by Half Boxplot", out.width="60%", echo=FALSE}
knitr::include_graphics("../results/half_boxplot.png")
```

```{r department-boxplot, fig.cap="Actual Productivity of Departments Boxplot", out.width="60%", echo=FALSE}
...
```{r actual-productivity-hist, fig.cap="Distribution of Actual Productivity", out.width="60%", echo=FALSE}
...
```{r QQ-plot,  fig.cap="Q-Q Plot of Actual Productivity", out.width="60%", echo=FALSE}
...
```{r foward-selection evalutation}
...
```{r assumptions-forward-selection}
